...
class MIT(Dataset):
    def __init__(self, data_root = "/mnt/lustre/sjtu/home/yzl02/Composed_BLIP/PW_H/trainSet",split = "train"):
...
class SJTU_TIS_0(Dataset):
    ...
    def __init__(self, data_root =  "/mnt/lustre/sjtu/home/yzl02/Composed_BLIP/SAL/data/saliency",split = "train"):
        self.data_root = data_root
