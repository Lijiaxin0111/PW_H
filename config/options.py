...
parser.add_argument('--expri', type=str, default='', help='experiment name')
...
parser.add_argument('--accumulation_steps', type=int, default=4, help='')
...
parser.add_argument("--stage", type=int, default=2, help='stage 1: learning distinguish between bad and better; stage 2: learning more detail')
...
parser.add_argument('--dataset', type=str, default= "AGIQA_3K")
# test settings
